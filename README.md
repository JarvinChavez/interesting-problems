...
| Folder | Topic |
|--------|-------|
| [pdf-to-grid-overlay](pdf-to-grid-overlay/) | Convert documents to images and overlay coordinate grids (OpenCV) |
| [longest-substring-without-repeating](longest-substring-without-repeating/) | Classic sliding-window string problem |
| [motif-bracket-expansion](motif-bracket-expansion/) | Expand bracketed amino-acid motif patterns for sequence search |
| [stale-user-cache](stale-user-cache/) | Redis cache invalidation after username update (Node.js) |
